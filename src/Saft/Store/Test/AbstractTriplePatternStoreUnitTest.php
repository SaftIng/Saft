...
class AbstractTriplePatternStoreUnitTest extends TestCase
{
    ...
    public function testAddStatements()
    {
        ...
        ->will($this->returnCallback(function(StatementIterator $statements, $graphUri = null, array $options = array()) {
    ...
    public function testDeleteMatchingStatements()
    {
        ...
        ->will($this->returnCallback(function(Statement $statement, $graphUri = null, array $options = array()) {
            PHPUnit_Framework_Assert::assertEquals(
