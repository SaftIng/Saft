...
{    
     ...
     * @var array
     */
    protected $_invalidatedEntriesDuringTransaction;
     ...
     * @var string
     */
    protected $_relatedQueryCacheEntryList;
    
    /**
     * @var array
     */
    protected $_runningTransactions;
    ...
    {
        $this->_placedOperations[$this->_activeTransaction][] = array(
    ...
    {
        $return = true === $useKeyPrefix ? $this->_keyPrefix : "";
    ...
    {
        return $this->_relatedQueryCacheEntryList;
    }
    ...
    {
        return $this->_runningTransactions;
    }
    ...
    public function init(\Saft\Cache $cache)
    {
        ...
        $this->_invalidatedEntriesDuringTransaction = array();
        
        // prefix for all short IDs generated by generateShortId
        $this->_keyPrefix = "queryCache--";
        
        $this->_placedOperations = array();
        
        $this->_runningTransactions = array();
        
        // Contains a list of cache IDs which each refers to a list of QueryCache
        // entries, which are belonging together
        $this->_relatedQueryCacheEntryList = "";
        ...
        if (false !== $queryIds) {
            ...
            foreach ($queryIds as $queryId) {
                ...
                if (true === $this->isATransactionActive()) {
                    $this->_invalidatedEntriesDuringTransaction[$queryId] = $queryId;
                }
                
                /**
                 * Unset query part of the cache
                 */
                $this->_cache->delete($queryId);
            }
        }
        ...
        $checkForRelatedQueryCacheEntries = true)
    {
        ...
        if (true === is_array($queryContainer["graphIds"])) {
            foreach ($queryContainer["graphIds"] as $graphId) {
                $graphCacheEntry = $this->_cache->get($graphId);
                ...
                // otherwise save updated entry 
                    ...
                    $this->_cache->set($graphId, $graphCacheEntry);
                }
            }
        }
    ...
    {
        return null !== $this->_activeTransaction;
    }
    ...
    public function rememberQueryResult($query, $result, $checkTransaction = true)
    {
         ...
         */
        $queryCacheEntry = $this->_cache->get($queryId);
        ...
        foreach ($simpleQuery->getFrom() as $graphUri) {
            ...
            // get cache entry
            $graphContainer = $this->_cache->get($graphId);
            ...
            $this->_cache->set($graphId, $graphContainer); 
        ...
        foreach ($graphIds as $graphId) {
            ...
            foreach ($triplePatterns as $triplePattern) {
                ...
                $patternKey = $graphId . "_" . $subjectHash . "_" . $predicateHash . 
                                         "_" . $objectHash;
                $this->_cache->set($patternKey, $queryId);
        ...
        $this->_cache->set($queryId, $queryCacheEntry);
    }
    ...
    public function startTransaction()
    {
        ...
        $this->_activeTransaction = count($this->_runningTransactions);
        
        $this->_runningTransactions[$this->_activeTransaction] = "active";
    ...
    public function stopTransaction()
    {
        ...
        $placedOperations = $this->_placedOperations[$this->_activeTransaction];
        ...
        if (0 == $this->_transactionMode) {
            ...
            foreach ($this->_placedOperations as $transactionId => $operations) {
            ...
            $this->_cache->set($entryId, $relatedQueryCacheEntries);
            $this->_relatedQueryCacheEntryList = $entryId;
            
            foreach ($relatedQueryCacheEntries as $queryCacheEntryId) {
                
                if (true === isset($this->_invalidatedEntriesDuringTransaction[$queryCacheEntryId])) {                    
                    continue;
                }
                ...
                $this->_cache->set($queryCacheEntryId, $queryContainer);
            }
            
            /**
             * clean up and remove data
             */
            $this->_runningTransactions[$this->_activeTransaction] = "finished";
            
            if (0 < $this->_activeTransaction) {                
                ...
                $transactionIds = array_keys($this->_runningTransactions);
                rsort($transactionIds);
                foreach ($transactionIds as $id) {
                    if ("active" == $this->_runningTransactions[$id]) {
                        $this->_activeTransaction = $id;
                        break;
                    }
                }
