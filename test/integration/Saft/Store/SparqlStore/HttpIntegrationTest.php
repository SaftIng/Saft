...
class HttpIntegrationTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Tests determineStoreOnServer
     */
     
    public function testDetermineStoreOnServerUnknownServer()
    {
        $this->assertNull($this->fixture->determineStoreOnServer(array('Server' => time())));
    }
     
    public function testDetermineStoreOnServerVirtuosoServer()
    {
        $this->assertEquals(
            'virtuoso',
            $this->fixture->determineStoreOnServer(array('Server' => 'Virtuoso/06.01.3127 (Linux) i686-pc-linux-gnu'))
        );
    }
